...
class MixGCF(GeneralRecommender):
    ...
    def __init__(self, config, dataset):
        super(MixGCF, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        # s_e = self.user_embedding(user)
        # p_e = self.item_embedding(pos_item)
        # n_e = self.item_embedding(neg_item)
